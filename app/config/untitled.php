...
class AutomatedReportsController extends BaseController
{
    ...
    public function generate_pregnancy_report_csv()
    {
        ...
        // \Mail::send('test', array(), function($message)
        //     {
        //         $message->sender('vaismay@gmail.com');
        //         $message->to('harshad@curotec.com', 'Cron Job')->subject('Just a test!');
        //     });
    ...
    if (strpos(getcwd(), 'public') !== false) {
            ...
            $filename = $baselink . uniqid(). $filename;
     ...
     // $f = fopen('php://memory', 'w');
       ...
       // $fname = str_replace("public/", "", $filename);
      //  $server_url = \URL::to('/');
        


        //  \Mail::send('emails.report', array('file_url' => $fname, 'server_url'=>$server_url), function($message)
        // {
        // $message->sender('vaismay@gmail.com');
        // $message->to('harshad@curotec.com', 'Report Desk')->subject('Automated Stellarrx report!');
        // });
