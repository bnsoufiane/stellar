<table id="{{ $id }}" class="{{ $class }}">
    <thead>
    <?php
    $columns_count = ($values['program']->type == \Program::TYPE_POSTPARTUM) ? 33 : 30;
    ?>
    <tr>
...
@section('scripts')
    ...
    <script>
        mytable = $('table').DataTable({
            ...
            "stateSave": true,
            columns: [
                null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null @if($values['program']->type == \Program::TYPE_POSTPARTUM), null, null, null @endif
            ],
        ...
        var _href = " <?php echo URL::route('admin.reports.generate_returned_gift_card_report_csv') ?>?" + url;
