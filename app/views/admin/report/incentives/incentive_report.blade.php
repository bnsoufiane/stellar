    ...
    <div class="container-fluid program_report">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="input-group input-group-lg sepH_a date_range_area" @if(count($programs)==0)
                ...
                <div class="input-group input-group-lg sepH_a pregnancy_report_type_area">
                    ...
                    {{ Form::radio('report_version', \Program::INCENTIVE_REPORT_VERSION_OLD, true) }} Old
                    version - Incentive Date<br>
                    {{ Form::radio('report_version', \Program::INCENTIVE_REPORT_VERSION_NEW) }} New Version - Incentive Date <br>
                     {{ Form::radio('report_version', \Program::INCENTIVE_REPORT_VERSION_OLD_DOS) }} Old
                    version - DOS<br>
                    {{ Form::radio('report_version', \Program::INCENTIVE_REPORT_VERSION_NEW_DOS) }} New Version - DOS <br>
                </div>
