    ...
    <div class="row sepH_a">
        ...
        <div class="col-lg-8">
            <div class="input-group input-group-lg sepH_a">
                ...
                {{Form::select('visit_date_verified_by_'.$scheduled_visit_id, $visit_date_verified, !empty($actual_visit->visit_date_verified_by)?$actual_visit->visit_date_verified_by:null, array('class' => 'form-control'))}}
            </div>
        </div>
    </div>
            ...
            <div class="row sepH_a">
                ...
                <div class="col-lg-8">
                    <div class="input-group input-group-lg sepH_a">
                        ...
                        {{Form::select($field_name, $outreach_codes, Input::old('manual_outreach_code'), array('class' => 'form-control manual_outreach_related_field', 'disabled'))}}
                    </div>
                </div>
            </div>
